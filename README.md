...
* **Telemetry Schemas:**
  * 🟠 **Autel** — [DATA_SCHEMA.md](docs/DATA_SCHEMA.md) — 50+ MQTT telemetry fields (RTK, Smart Battery, Radar, etc.)
  * 🔵 **DJI** — [DJI_DATA_SCHEMA.md](docs/DJI_DATA_SCHEMA.md) — DJI Cloud API MQTT fields (Matrice 30T, 350 RTK, Mavic 3E)
  * 🟢 **Dronelink** — [DRONELINK_DATA_SCHEMA.md](docs/DRONELINK_DATA_SCHEMA.md) — Normalized cross-platform telemetry (DJI + Autel + Parrot)
  * 🟣 **Litchi** — [LITCHI_DATA_SCHEMA.md](docs/LITCHI_DATA_SCHEMA.md) — CSV flight log export field reference (all Litchi-supported DJI drones)
